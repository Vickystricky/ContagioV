...
const params = {
	...
	frictionBase: 2,
	frictionHigh: 0.45,
	maxGraphRadius: 20,         		// radio máximo deseado
	maxCenteringForce: 0.10   			// fuerza máxima centrípeta para contener el grafo
};
...
const curadoresChangeInterval = 2000;  // tiempo en ms para cambiar valor
...
const radiusMin = 5;
const radiusMax = 30;
const rotationSpeed = 0.5; 		// rotación en radianes por segundo
const zoomSpeed = 0.5;       	// velocidad de oscilación zoom
...
const bokehPass = new BokehPass(scene, camera, {
  ...
  maxblur: 0,        // máximo nivel de blur general
...
const sphereGeometry = new THREE.SphereGeometry(0.3, 20, 8);
